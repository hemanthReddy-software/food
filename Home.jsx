...
function Home() {
  ...
  // ✅ Setup countdown timer (4 hours deals)
  useEffect(() => {
    const dealEndTime = new Date().getTime() + 4 * 60 * 60 * 1000; // 4 hours from now
    ...
    const interval = setInterval(() => {
      ...
      if (distance <= 0) {
        ...
        setDealsActive(false); // Hide deals when expired
      } else {
        setTimeLeft({
  ...
  return (
    <div>
      ...
      {/* ✅ Video Background with Start Shopping Button */}
      <motion.div
        variants={sectionVariant}
        initial="hidden"
        whileInView="visible"
